...
<table class="snack">
	<tr>
		<td>
			<figure>
				<img src="../images/snack1.jpg" width="200px" height="150px">
				<figcaption>관절영양제: 15000원</figcaption>
			</figure>
		</td>
		<td>
			<figure>
				<img src="../images/snack2.jpg" width="200px" height="150px">
				<figcaption>수제육포: 10000원</figcaption>
			</figure>
		</td>
		<td>
			<figure>
				<img src="../images/snack3.jpg" width="200px" height="150px">
				<figcaption>반려견용 우유: 5000원</figcaption>
			</figure>
		</td>
		<td>
			<figure>
				<img src="../images/snack4.jpg" width="200px" height="150px">
				<figcaption>치석제거용 개껌: 3000원</figcaption>
			</figure>
		</td>
	</tr>
	<tr>
		<td>
			<figure>
				<img src="../images/snack5.jpg" width="200px" height="150px">
				<figcaption>오리도가니: 10000원</figcaption>
			</figure>
		</td>
	</tr>
</table>
<button style="margin-left: 42%; width: 160px; height: 40px; font-size: 15px" onclick="replace()">주문하러가기</button>
</div>
<div id="footer">
<table>
	<tr>
