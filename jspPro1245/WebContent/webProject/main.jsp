...
if(isShow) {
%>
window.open("notice.jsp", "popup", "width=310, height=350, left=600, top=100, scrollbars=no, toolbars=no, location=no");
<% } %>
}
</script>
...
<div id="nav">
	...
	<div class="menu">강아지용품
		<div class="me"><a style="text-decoration: none; font-style: normal;" href="${path}/webProject/snack.jsp">간식</a></div>
		<div class="me"><a style="text-decoration: none; font-style: normal;" href="${path}/webProject/toy.jsp">장난감</a></div>
	</div>
