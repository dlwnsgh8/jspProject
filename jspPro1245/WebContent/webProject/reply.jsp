...
<form name="form1" method="post" action="${path}/board_servlet/insertReply.do">
	<table style="border-style:none; margin-top: 30px; padding-bottom: 0px; margin-left:-65px; width:1300px;" border="1">
		<tr><td class="menu_2">이름</td><td><input name="writer" id="writer"></td></tr>
		<tr><td class="menu_2">제목</td><td><input name="subject" id="subject" value="Re: ${dto.subject}" size="60"></td></tr>
		<tr><td class="menu_2">본문</td><td><textarea rows="5" cols="60" name="content" id="content">${dto.content}</textarea></td></tr>
		<tr><td class="menu_2">첨부파일</td><td><input type="file" name="file1"></td></tr>
		<tr><td class="menu_2">비밀번호</td><td><input type="password" name="passwd" id="passwd"></td></tr>
	</table>
	<table style="border-style:none; margin-top: 0px; margin-left:-65px; width:1300px;">
		<tr><td align="right">
			<input type="hidden" name="num" value="${dto.num}">
			<input type="button" value="확인" id="btnSave"></td></tr>
	</table>
</form>
</div>
<div id="footer">
